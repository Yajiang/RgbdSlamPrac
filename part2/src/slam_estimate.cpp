...
int main( int argc, char** argv )
{
    ...
    cv::Mat rgb_data_1 = cv::imread( "./data/rgb_data_1.png");
    cv::Mat rgb_data_2 = cv::imread( "./data/rgb_data_2.png");
    cv::Mat depth_data_1 = cv::imread( "./data/depth_data_1.png", -1);
    cv::Mat depth_data_2 = cv::imread( "./data/depth_data_2.png", -1);
    ...
    // 可视化：显示匹配的特征
    cv::Mat imgMatches;
    cv::drawMatches( rgb_data_1, kp1, rgb_data_2, kp2, matches, imgMatches );
    ...
    cv::drawMatches( rgb_data_1, kp1, rgb_data_2, kp2, good_matches, imgMatches );
    ...
    for (size_t i=0; i<good_matches.size(); i++)
    {
        ...
        ushort d = depth_data_1.ptr<ushort>( int(p.y) )[ int(p.x) ];
        if (d == 0)
            continue;
    ...
    cv::drawMatches( rgb_data_1, kp1, rgb_data_2, kp2, matchesShow, imgMatches );
